...
import { processImage } from './uploadImage.utilities.js';
const { AWS_REGION, AWS_BUCKET, AWS_ACCESS_KEY, AWS_SECRET_ACCESS_KEY } = process.env;
export const uploadToS3 = async (picture) => {
    try {
