...
import {type RefinedComment, type CommentFromDatabase} from './getComments';
...
likeDislikeComment.put(
	...
	async (req, res) => {
		try {
			...
			const {commentId, action}: CommentVar = req.body as CommentVar;
			...
			const comment: CommentFromDatabase = updatedPost?.rows[0] as CommentFromDatabase;
			...
			const refinedComment: RefinedComment = {
				id: comment.id,
